...
const [profile, setProfile] = useState(null);
  ...
  const handleProfileClick = () => {
    ...
    return (
        ...
        <main>
            <header className="w-full sticky top-0 border-1 transition-all duration-200">
                <div className="flex w-full px-4">
                    <div className="flex-1 flex justify-center text-xl">
                        <NavigationMenu>
                            <NavigationMenuList>
                                {navItems.map((item, index) => (
                                    <NavigationMenuItem key={index} className="pt-2 pb-2 pr-7 pl-7  hover:animate-ping">
